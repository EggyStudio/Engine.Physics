...
public struct PhysicsMaterial
{
    ...
    public static PhysicsMaterial Default => new() { Friction = 1f, Restitution = 0f, LinearDamping = 0f, AngularDamping = 0f };
}

/// <summary>Result of an <see cref="IPhysicsWorld.Raycast(Vector3,Vector3,float,out RaycastHit)"/>.</summary>
